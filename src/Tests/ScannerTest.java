...
class ScannerTest {
    ...
    void peek_ReadsToken_Finds_MASTER_Token() throws IOException {
        ...
        Mockito.when(mockBufferedReader.read()).thenReturn((int) 'M', (int) 'A', (int) 'S', (int) 'T', (int) 'E', (int) 'R', (int) ' ');
        Reader reader = new Reader(mockBufferedReader);
        Scanner scanner = new Scanner(reader, mockTokenizer);
    ...
    void advance_findsNewToken_Returns_tokensNotEqual() throws IOException {
        ...
        Mockito.when(mockBufferedReader.read()).thenReturn((int) 'M', (int) 'A', (int) 'S', (int) 'T', (int) 'E', (int) 'R', (int) ' ', (int) 'i', (int) 'n', (int) 't',(int) ' ');
        Reader reader = new Reader(mockBufferedReader);
        Scanner scanner = new Scanner(reader, mockTokenizer);
